...
class SmOrder extends Model
{
    ...
    public function getOrderStatusNameAttribute(){
        if($this->is_pay < 2 && $this->is_cancel == 0){
            $order_status_name = "待付款";
        }else if($this->is_pay == 2 && $this->is_send == 0){
            $order_status_name = "待发货";
        }else if($this->is_pay == 2 && $this->is_send == 1 && $this->is_get == 0){
            $order_status_name = "待收货";
        }else if($this->is_pay == 2 && $this->is_send == 1 && $this->is_get == 1){
            $order_status_name = "已完成";
        }else if($this->is_pay < 2 && $this->is_cancel == 1){
