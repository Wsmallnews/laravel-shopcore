...
class CreateSmshopOrderActionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('smshop_order_actions', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('smshop_order_actions');
    }
}
